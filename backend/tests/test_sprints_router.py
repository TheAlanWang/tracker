...
async def test_list_sprints_200(client, make_token):
...
async def test_create_sprint_201(client, make_token):
...
async def test_start_sprint_200(client, make_token):
...
async def test_start_sprint_another_active_422(client, make_token):
...
async def test_complete_sprint_200(client, make_token):
    with patch(
